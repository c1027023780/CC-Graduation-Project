...
typedef  void (*fun_adc_init)(uint_8 chnGroup,uint_8 diff,uint_8 accurary,uint_8 HDAve);
volatile fun_adc_init adc_init;
...
typedef  uint_16 (*fun_adc_read)(uint_8 channel);
volatile fun_adc_read adc_read;
