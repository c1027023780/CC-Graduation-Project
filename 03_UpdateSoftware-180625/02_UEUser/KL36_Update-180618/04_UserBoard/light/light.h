...
typedef  void (*fun_light_init)(uint_16 port_pin, uint_8 state);
volatile fun_light_init light_init;
...
typedef  void (*fun_light_control)(uint_16 port_pin, uint_8 state);
volatile fun_light_control light_control;
...
typedef  void (*fun_light_change)(uint_16 port_pin);
volatile fun_light_change light_change;
